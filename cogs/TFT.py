...
class TFT(commands.Cog):
        ...
        try:
            ...
            if summoner_id not in summoners:
                ...
                try:
                    ...
                    embed_msg = discord.Embed()
                    embed_msg.add_field(name="Message", value=f"Le joueur {summoner_name} n'a pas pu être enregistré, contacter l'administrateur.", inline=False),
    ...
    def get_player_puuid(self, summoner_name, region_route):
        """
        Obtenir l'identifiant (puuid) du joueur.
        Entrée : Un nom d'invocateur.
        Sortie : L'identifiant (puuid) de cet invocateur (un identificateur utilisé par Riot pour les joueurs).
        """
    ...
    def get_recentmatch_embed(self, match_data, summoner, queue):
        ...
        if placement == 1:
            embed_msg.add_field(name="Résultat",value=talkies.get_excited_line(), inline=False)
        elif placement > 4:
            embed_msg.add_field(name="Résultat",value=talkies.get_sad_line(), inline=False)
